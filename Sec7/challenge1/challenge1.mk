...
WorkspacePath          :=/home/ironman/Workspaces/cpp/Sec7
ProjectPath            :=/home/ironman/Workspaces/cpp/Sec7/challenge1
...
User                   :=MyungJun Lee
Date                   :=10/02/26
CodeLitePath           :=/home/ironman/.codelite
...
$(OutputFile): ../build-$(ConfigurationName)/challenge1/.d $(Objects) 
	@mkdir -p "../build-$(ConfigurationName)/challenge1"
...
../build-$(ConfigurationName)/challenge1/main.cpp$(ObjectSuffix): main.cpp ../build-$(ConfigurationName)/challenge1/main.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/home/ironman/Workspaces/cpp/Sec7/challenge1/main.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/main.cpp$(ObjectSuffix) $(IncludePath)
